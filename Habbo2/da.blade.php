{
  ...
  "RECOVER_PASSWORD_ERROR": "Your email and Kodeord do not match. Would you like to change your Kodeord?",
  "NEW_PASSWORD_AGAIN_LABEL": "Repeat new Kodeord",
  ...
  "ERROR_PASSWORD_CONTAINS_NAME": "Kodeord must not contain your user name.",
  ...
  "ERROR_PASSWORD_MIN_LENGTH": "Too weak, you need to make it longer. Kodeord has to be at least 6 character long.",
  ...
  "CLAIM_PASSWORD_TITLE": "Forgot Kodeord",
  ...
  "PASSWORD_CHANGE_HELP": "Brug mindst 6 tegn. Inkluder mindst ét bogstav og mindst et tal eller specialtegn.",
  ...
  "EU_COOKIE_BANNER": "{{$chocolatey->hotelName}} bruger sine egne og tredjeparts cookies for at give en bedre service og displayannonce, der passer til dine præferencer. Ved at bruge vores hjemmeside accepterer du vores cookiepolitik.",
  ...
  "META_DESCRIPTION": "Bliv medlem af millioner i verdens mest populære virtuelle verden for teenagere. Opret din avatar, møde nye venner, rollespil og byg fantastiske rum.",
  ...
  "EMAIL_REPORT_UNAUTHORIZED_SUCCESS": "E-mail adresse tilføjet til {{$chocolatey->hotelName}} blokerings liste.",
  ...
  "HEAD_TITLE_EMAIL_REPORT_UNAUTHORIZED": "Bloker e-mail addresse",
  ...
  "ERROR_PASSWORDS_NOT_MATCHING": "Kodeords stemmer ikke overens.",
  "SEE_ALL": "Se alle",
  ...
  "REPORT_REASON_19": "Indeholder <b>hate speech</b> (f.eks. racistisk, homofob, fremmedfjendsk, sexistisk)",
  ...
  "CREDITS_AMOUNT": "@{{value}} mønter og diamanter",
  ...
  "CLIENT_ERROR_TITLE": "Åh nej, kan det ikke {{$chocolatey->hotelName}}!",
  ...
  "CFH_REASON_RESOLVED_TARGET_PREFIX_BAN": "Du er blevet rapporteret af andre brugere for %times% i %days% og er nu blevet forbudt for: %reason%.",
  ...
  "CFH_REASON_RESOLVED_TARGET_BAN_PERMANENT": "Du er blevet permanent forbudt for: %reason%.",
  ...
  "MODERATOR_MSG_BAN": "Din {{$chocolatey-> hotelName}} er blevet forbudt indtil {0}.",
  ...
  "MODERATOR_MESSAGETEMPLATE_2": "Da webkameraer kan bruges til upassende kontakt, skal du holde op med at bede om kontakt på denne måde. Hvis du spørger igen, kan du blive forbudt, og ingen ønsker det",
